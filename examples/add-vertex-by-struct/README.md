# add-vertex-by-struct

The basics on adding vertices using the `AddVertexByStruct` function from a Grammes client.
...
- Adds a vertex to the graph using a Vertex struct
