...
The basics of setting up a client with a custom logger using a `ClientConfiguration` function.

## Description

**logger-example** demonstrates how to use a custom logger for your Grammes client. Specifically this examples shows off how to using the `WithLogger` function that takes in any object that satisfies the `Logger` interface.
